...
version = 1.0.0
# Используем только kivy, без python3, чтобы избежать конфликтов версий.
# Версия 2.3.0 проверена и стабильна для сборок.
...
# Версия Android SDK (инструменты разработки)
android.sdk = 31
